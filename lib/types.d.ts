 ...
 */
export declare type TypedArrayName = 'Uint8' | 'Uint16' | 'Uint32' | 'Int8' | 'Int16' | 'Int32' | 'Float32' | 'Float64' | 'BigInt64' | 'BigUint64';
/**
...
export declare type SchemaData<T> = SchemaObject<T> | SchemaObject<T>[];
/**
